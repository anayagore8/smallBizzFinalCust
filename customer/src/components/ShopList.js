...
// import styles from './ShopList.module.css'; // Import CSS module
...
//         setShopData(data);
//         setFilteredData(data); // Initialize filteredData with all shop data
//       } catch (error) {
...
//     // Filter shopData based on the search term
...
//     // Navigate to the shop's products page
